...
<head>
    ...
    <!-- Para DataTables third party css -->
                ...
                <div class="tab-pane active" id="settings-tab" role="tabpanel">
                    ...
                    <div class="p-3">
                        <div class="alert alert-warning" role="alert">
                            <strong>Personaliza </strong> el tema de tu aplicación web, esquema de color, sidebar menu,
                            etc.
                        </div>
                        ...
                        <div class="form-check form-switch mb-1">
                            ...
                            <label class="form-check-label" for="light-mode-check">Modo Luz</label>
                        </div>
                        ...
                        <div class="form-check form-switch mb-1">
                            <input type="checkbox" class="form-check-input" name="layout-width" value="boxed"
                                id="boxed-check" />
                            <label class="form-check-label" for="boxed-check">Encajonado</label>
                        </div>

                        <!-- Menu positions -->
                        <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Posición de Menus (Leftsidebar and Topbar)</h6>
                        ...
                        <!-- Left Sidebar-->
                        <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Color del Sidebar Izquierdo</h6>
                        ...
                        <!-- size -->
                        <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Tamaño del Sidebar Izquierdo</h6>
                        ...
                        <div class="form-check form-switch mb-1">
                            <input type="checkbox" class="form-check-input" name="leftbar-size" value="condensed"
                                id="condensed-check" />
                            <label class="form-check-label" for="condensed-check">Condensado <small>(Extra
                                    Pequeño)</small></label>
                        </div>
                        ...
                        <div class="form-check form-switch mb-1">
                            <input type="checkbox" class="form-check-input" name="leftbar-size" value="compact"
                                id="compact-check" />
                            <label class="form-check-label" for="compact-check">Compacto
                                <small>(Pequeño)</small></label>
                        </div>

                        <!-- User info -->
                        <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Info de Usuario en Sidebar</h6>
                        ...
                        <!-- Topbar -->
                        <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Encabezado (Topbar)</h6>
                        ...
                        <div class="form-check form-switch mb-1">
                            ...
                            <label class="form-check-label" for="lighttopbar-check">Luz</label>
                        </div>


                        <div class="d-grid mt-4">
                            <button class="btn btn-primary" id="resetBtn">Reset Valores</button>
